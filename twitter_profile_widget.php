...
function show_utwp_profile_widget($args)
{
	...
	echo '<div align="center"><small>Presented by <a href="http://yizhantech.com>philippine technology blogs</a></small></div>';
	} else
	echo '<div align="center" style="display:none;"><small>UTPW Presented by <a href="http://yizhantech.com>philippine technology blogs</a></small></div>';
{
}
}
         echo $after_widget;
